...
public class FooServiceWrapper
	...
	@Override
	public poc.db.model.Foo generateFooRow() {
		return _fooService.generateFooRow();
	}
	...
	@Override
	public void updateFoobyParam(poc.db.model.Foo foo) {
		_fooService.updateFoobyParam(foo);
	}
