...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	@Override
	public int compareTo(poc.db.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<poc.db.model.Foo>
		toCacheModel() {
	...
	@Override
	public poc.db.model.Foo toEscapedModel() {
	...
	@Override
	public poc.db.model.Foo toUnescapedModel() {
