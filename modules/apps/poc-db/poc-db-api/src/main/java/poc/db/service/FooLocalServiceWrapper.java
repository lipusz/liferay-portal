...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public poc.db.model.Foo addFoo(poc.db.model.Foo foo) {
	 ...
	 */
	@Override
	public poc.db.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public poc.db.model.Foo deleteFoo(poc.db.model.Foo foo) {
	 ...
	 */
	@Override
	public poc.db.model.Foo deleteFoo(long fooId)
	...
	@Override
	public poc.db.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public poc.db.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 */
	@Override
	public poc.db.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public poc.db.model.Foo getFooByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<poc.db.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<poc.db.model.Foo> getFoosByUuidAndCompanyId(
	 ...
	 */
	@Override
	public poc.db.model.Foo updateFoo(poc.db.model.Foo foo) {
