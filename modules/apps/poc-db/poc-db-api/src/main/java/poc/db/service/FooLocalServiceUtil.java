 ...
 * <code>poc.db.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>poc.db.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static poc.db.model.Foo addFoo(poc.db.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static poc.db.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static poc.db.model.Foo deleteFoo(poc.db.model.Foo foo) {
	 ...
	 */
	public static poc.db.model.Foo deleteFoo(long fooId)
	...
	public static poc.db.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static poc.db.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static poc.db.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static poc.db.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<poc.db.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	public static java.util.List<poc.db.model.Foo> getFoosByUuidAndCompanyId(
	...
	public static java.util.List<poc.db.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<poc.db.model.Foo>
			orderByComparator) {
	 ...
	 */
	public static poc.db.model.Foo updateFoo(poc.db.model.Foo foo) {
