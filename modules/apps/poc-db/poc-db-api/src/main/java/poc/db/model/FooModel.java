...
/**
 * The base model interface for the Foo service. Represents a row in the &quot;POC_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>poc.db.model.impl.FooModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>poc.db.model.impl.FooImpl</code>.
 * </p>
 *
...
public interface FooModel
	...
	@Override
	public CacheModel<poc.db.model.Foo> toCacheModel();
