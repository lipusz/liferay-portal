	...
	<span class="asset-entry">
		<span class="asset-entry-type">
			...
			<c:if test="<%= locale != summary.getLocale() %>">
				<liferay-ui:icon image='<%= "../language/" + LocaleUtil.toLanguageId(summary.getLocale()) %>' message='<%= LanguageUtil.format(locale, "this-result-comes-from-the-x-version-of-this-web-content", LocaleUtil.getLanguageKeyForLocale(summary.getLocale()), true) %>' />
			</c:if>
		</span>
